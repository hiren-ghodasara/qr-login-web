  ...
  return (
    <div className="container">
      <div className="row mt-3">
        ...
        <div className="col">
          ...
          <div className="mt-2">
            <ul className="list-group">
              <li className="list-group-item list-group-item-primary">Dapibus ac facilisis in</li>
              <li className="list-group-item list-group-item-secondary">Cras justo odio</li>
              ...
              <li className="list-group-item list-group-item-warning">Vestibulum at eros</li>
              <li className="list-group-item list-group-item-info">Cras justo odio</li>
              <li className="list-group-item list-group-item-light">Dapibus ac facilisis in</li>
        ...
        {/*Progress*/}
        <div className="col">
          <div className="card text-white bg-primary mb-2 d-inline-block" style={{ maxWidth: "18rem" }}>
          ...
          <div className="card text-white bg-secondary mb-2 d-inline-block" style={{ maxWidth: "18rem" }}>
            <div className="card-header">Header</div>
            <div className="card-body">
          ...
          <div className="card text-white bg-success mb-2 d-inline-block" style={{ maxWidth: "18rem" }}>
            <div className="card-header">Header</div>
            <div className="card-body">
          ...
          <div className="card text-white bg-danger mb-2 d-inline-block" style={{ maxWidth: "18rem" }}>
            <div className="card-header">Header</div>
            <div className="card-body">
          ...
          <div className="card text-white bg-warning mb-2 d-inline-block" style={{ maxWidth: "18rem" }}>
            <div className="card-header">Header</div>
            <div className="card-body">
          ...
          <div className="card text-white bg-info mb-2 d-inline-block" style={{ maxWidth: "18rem" }}>
            <div className="card-header">Header</div>
            <div className="card-body">
          ...
          <div className="card bg-light mb-2 d-inline-block" style={{ maxWidth: "18rem" }}>
            <div className="card-header">Header</div>
            <div className="card-body">
          ...
          <div className="card text-white bg-dark mb-2 d-inline-block" style={{ maxWidth: "18rem" }}>
            <div className="card-header">Header</div>
            <div className="card-body">
